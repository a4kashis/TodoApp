                ...
                child: Column(
                  children: [
                    ...
                    InkWell(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                          ...
                          border:
                              Border.all(color: Color(0xff888888), width: 1.0),
                        ),
                    ...
                    CustomTextField(
                      ...
                      onTap: () =>
                          AppUtils.getBottomSheet(children: [UsersList()]),
                      label: 'Share with',
                    ),
                    ...
                    Obx(
                      () => SwitchListTile(
                        ...
                        title: Text("Completed", style: Styles.tsWhiteLight14),
                    ...
                    PrimaryFilledButton(
                        text:
                            "${controller.taskId.isEmpty ? "ADD" : "UPDATE"} YOUR THING",
